                    ...
                    <div class="relative rounded-3xl bg-white/5 p-4 backdrop-blur shadow-[0_32px_90px_-45px_rgba(15,23,42,0.85)]">
                        <div class="grid gap-4">
                            <div class="overflow-hidden rounded-2xl ring-1 ring-white/10">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/images/services/walmart-seller.jpg" alt="Team preparing Walmart Marketplace application" class="h-56 w-full object-cover" loading="lazy" />
                            </div>
                            <div class="grid grid-cols-2 gap-4">
                                <div class="overflow-hidden rounded-2xl ring-1 ring-white/10">
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/images/services/amazon-seller.jpg" alt="Marketplace specialist reviewing compliance documents" class="h-32 w-full object-cover" loading="lazy" />
                                </div>
                                <div class="overflow-hidden rounded-2xl ring-1 ring-white/10">
                        ...
                        <div class="absolute -bottom-6 left-1/2 hidden w-72 -translate-x-1/2 rounded-3xl border border-white/10 bg-slate-900/85 p-5 shadow-lg shadow-black/30 backdrop-blur lg:block" x-data="{ highlights: ['Invitation strategy and approval support in under 30 days', 'Dedicated Walmart pod for compliance, logistics, and ad readiness', 'Growth roadmap covering catalog expansion and buy box wins'], active: 0 }" x-init="setInterval(() => { active = (active + 1) % highlights.length }, 4200)">
