    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid items-center gap-16 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
            <div class="space-y-10">
                <?php include get_template_directory() . '/template-parts/amazon-seller/hero-components/hero-content.php'; ?>
            </div>
                    ...
                    <div class="relative rounded-3xl bg-white/5 p-4 backdrop-blur shadow-[0_32px_90px_-45px_rgba(15,23,42,0.85)]">
                        <div class="grid gap-4">
                            <div class="overflow-hidden rounded-2xl ring-1 ring-white/10">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/images/services/amazon-seller.jpg" alt="Amazon seller onboarding session" class="h-56 w-full object-cover" loading="lazy" />
                            </div>
                            <div class="grid grid-cols-2 gap-4">
                                <div class="overflow-hidden rounded-2xl ring-1 ring-white/10">
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/images/services/walmart-seller.jpg" alt="Marketplace approval expert preparing documents" class="h-32 w-full object-cover" loading="lazy" />
                                </div>
                                <div class="overflow-hidden rounded-2xl ring-1 ring-white/10">
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/dist/images/services/resale-certificate.jpg" alt="Compliance team organizing resale certificates" class="h-32 w-full object-cover" loading="lazy" />
                                </div>
                            </div>
                        </div>

                        <div class="absolute -bottom-6 left-1/2 hidden w-72 -translate-x-1/2 rounded-3xl border border-white/10 bg-slate-900/85 p-5 shadow-lg shadow-black/30 backdrop-blur lg:block" x-data="{ highlights: ['Seller Central approval packs completed in 72 hours', 'Dedicated launch pod for FBA, tax, and compliance workflows', 'Post-launch growth playbooks with inventory and ad checkpoints'], active: 0 }" x-init="setInterval(() => { active = (active + 1) % highlights.length }, 4200)">
