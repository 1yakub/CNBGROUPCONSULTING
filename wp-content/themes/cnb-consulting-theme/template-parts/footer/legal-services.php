...
<div class="space-y-4">
    ...
    <ul class="space-y-3">
        <li><a href="<?php echo esc_url(home_url('/services/company-formation/')); ?>" 
        ...
        <li><a href="<?php echo esc_url(home_url('/services/ein-service/')); ?>" 
               class="text-slate-300 hover:text-cnb-secondary transition-colors duration-200 flex items-center group">
            <svg class="w-4 h-4 mr-2 text-slate-500 group-hover:text-cnb-secondary transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
            </svg>
        ...
        <li><a href="<?php echo esc_url(home_url('/services/itin-service/')); ?>" 
               class="text-slate-300 hover:text-cnb-secondary transition-colors duration-200 flex items-center group">
            <svg class="w-4 h-4 mr-2 text-slate-500 group-hover:text-cnb-secondary transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <li><a href="<?php echo esc_url(home_url('/services/registered-agent/')); ?>" 
               class="text-slate-300 hover:text-cnb-secondary transition-colors duration-200 flex items-center group">
            <svg class="w-4 h-4 mr-2 text-slate-500 group-hover:text-cnb-secondary transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <li><a href="<?php echo esc_url(home_url('/services/ecommerce-registration/')); ?>" 
               class="text-slate-300 hover:text-cnb-secondary transition-colors duration-200 flex items-center group">
            <svg class="w-4 h-4 mr-2 text-slate-500 group-hover:text-cnb-secondary transition-colors duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
