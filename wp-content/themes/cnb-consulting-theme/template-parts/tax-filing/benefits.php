<?php
/**
 * Tax Filing Service - Benefits Section
 * 
 * @package CNB_Consulting_Theme
 */
?>

<section id="tax-filing-process" class="relative bg-slate-950 py-20 lg:py-24 text-white" x-data="{ activeStep: 0 }">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-6 text-center">
            ...
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-semibold"><?php echo esc_html__('Tax filings delivered through four proven checkpoints', 'cnb-consulting-theme'); ?></h2>
            <p class="mx-auto max-w-3xl text-base text-white/70">
                <?php echo esc_html__('Every milestone is led by your CPA pod with visibility into what we are completing and the documents we request. Hover or tap to explore each stage.', 'cnb-consulting-theme'); ?>
            </p>
        </div>
        ...
        $steps = array(
            array(
                'title' => __('Onboarding & ledger alignment', 'cnb-consulting-theme'),
                'description' => __('Connect your bookkeeping, payroll, and investor portals. We reconcile ledgers, identify gaps, and deliver a kickoff roadmap in 48 hours.', 'cnb-consulting-theme'),
                'cta' => __('Approve reconciliation plan', 'cnb-consulting-theme'),
            ),
            array(
                'title' => __('Tax package preparation', 'cnb-consulting-theme'),
                'description' => __('We prepare draft returns, supporting schedules, and planning scenarios for review. Every assumption is documented for clarity.', 'cnb-consulting-theme'),
                'cta' => __('Review draft filings', 'cnb-consulting-theme'),
            ),
            array(
                'title' => __('CPA + client review session', 'cnb-consulting-theme'),
                'description' => __('Walk through results, tax savings, and next-year adjustments live with your pod leader, then execute digital signatures securely.', 'cnb-consulting-theme'),
                'cta' => __('Sign & authorize submission', 'cnb-consulting-theme'),
            ),
            array(
                'title' => __('Submission & year-round support', 'cnb-consulting-theme'),
                'description' => __('We transmit returns, deliver acceptance confirmations, set up quarterly reminders, and monitor IRS/state notices for continued compliance.', 'cnb-consulting-theme'),
                'cta' => __('Access post-filing dashboard', 'cnb-consulting-theme'),
            ),
        );
        ?>
