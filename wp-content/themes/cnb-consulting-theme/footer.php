        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-b border-slate-800 py-8">
                <div class="flex flex-wrap justify-center gap-6">
                    ...
                    <!-- LinkedIn -->
                    <a href="#" target="_blank" rel="noopener" 
                       class="group flex items-center space-x-3 bg-slate-800 hover:bg-blue-700 px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105">
                        <div class="w-8 h-8 bg-blue-700 group-hover:bg-white rounded-full flex items-center justify-center transition-colors duration-300">
                            <svg class="w-4 h-4 text-white group-hover:text-blue-700 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                            </svg>
                        </div>
                        <span class="font-medium group-hover:text-blue-100 transition-colors duration-300">LinkedIn</span>
                    </a>

                    <!-- WhatsApp -->
                    <a href="#" target="_blank" rel="noopener" 
                       class="group flex items-center space-x-3 bg-slate-800 hover:bg-green-600 px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105">
                        <div class="w-8 h-8 bg-green-600 group-hover:bg-white rounded-full flex items-center justify-center transition-colors duration-300">
                            <svg class="w-4 h-4 text-white group-hover:text-green-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <a href="tel:09638117711" class="text-slate-300 hover:text-cnb-secondary transition-colors duration-200 font-medium">
                                        09638117711
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:sales@businessglobalizer.com" class="text-slate-300 hover:text-cnb-secondary transition-colors duration-200 font-medium">
                                        sales@businessglobalizer.com
                                    </a>
                                </div>
                            </div>
            ...
            <div class="border-t border-slate-800 py-6">
                <div class="text-center">
                    <p class="text-slate-400">
                        Copyright © <?php echo esc_html(date('Y')); ?> All rights reserved.
                    </p>
                </div>
            </div><!-- .footer-bottom -->
